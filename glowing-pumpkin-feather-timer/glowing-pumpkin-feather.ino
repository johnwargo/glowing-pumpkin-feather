...
/**************************************************************************
   Specifies the Feather pin the NeoPixel is connected to.
   ...
   As we're using the Huzzah, we'll make this 15. Set this based on which
   Feather board you use for your project
 **************************************************************************/
#define PIN 15
